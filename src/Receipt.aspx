    ...
    <form id="frmReceipt" runat="server">
        ...
        <div style="position: absolute; top: auto; margin: 0; left: 50%; transform: translate(-50%, 0%);">
            <div class="DIVCenterHorizental">
                ...
                <br />
                <br />
                <asp:TextBox runat="server" ID="txtDate" TextMode="Date" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                <br />
                <br />
                ...
                <br />
                <asp:TextBox runat="server" ID="txtDonorName" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                <br />
                <br />
                ...
                <br />
                <asp:TextBox runat="server" ID="txtMobileNumber" Width="230px" MaxLength="10" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>

                <asp:Button runat="server" ID="btnGetData" Width ="50px" Text="?" class="btn Lobster-BlodItalic"></asp:Button>
                <br />
                <br />
                <asp:Label runat="server" ID="lblDonorEmail" Text="Email :" CssClass="PlayBoldText FontSizeMediumNormal"></asp:Label>
                <br />
                <asp:TextBox runat="server" ID="txtDonorEmail" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                <br />
                <br />
                <asp:Label runat="server" ID="lblAmount" Text="Amount :" CssClass="PlayBoldText FontSizeMediumNormal"></asp:Label>
                <br />
                <asp:TextBox runat="server" ID="txtAmount" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                <br />
                <br />
                ...
                <br />
                <asp:TextBox runat="server" ID="txtDocumentNumber" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                <br />
                <br />
             ...
             <asp:Label runat="server" ID="lblModeofDonation" Text="Mode of Donation :" CssClass="PlayBoldText FontSizeMediumNormal"></asp:Label>
                ...
                <br />
                <asp:TextBox runat="server" ID="txtTransectionChaqueNumber" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                <br />
                <br />
                <asp:Label runat="server" ID="lblPaymentDate" Text="Payment Date :" CssClass="PlayBoldText FontSizeMediumNormal"></asp:Label>
                <br />
                <asp:TextBox runat="server" ID="txtPaymentDate" TextMode="Date" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()" ></asp:TextBox>
                <br />
                <br />
                <asp:Label runat="server" ID="lblBankName" Text="Bank Name :" CssClass="PlayBoldText FontSizeMediumNormal"></asp:Label>
                <br />
                <asp:TextBox runat="server" ID="txtBankName" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                <br />
                <br />
                <asp:Label runat="server" ID="lblBranchName" Text="Branch Name :" CssClass="PlayBoldText FontSizeMediumNormal"></asp:Label>
                <br />
                <asp:TextBox runat="server" ID="txtBranchName" Width="300px" CssClass="RoundCornerWithBorder PlayText FontSizeNormal" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                <br />
                <br />
                ...
                <br />
                  ...
                  <div class="AlignCenter">
                    ...
                    <asp:Button runat="server" ID="btnLogout" Text="Logout" Width="100%" class="btn Lobster-BlodItalic"></asp:Button>

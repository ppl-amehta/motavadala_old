        ...
        Try
            ...
            Using conn As SqlConnection = ReturnConnection()
                        ...
                        If txtPassword.Text = reader.Item(11).ToString Then
                            ...
                            If reader.Item(12).ToString.ToUpper = "YES" Then
                                ...
                                If reader.Item(13).ToString.ToUpper = "ADMIN" Then
                                    ...
                                    Session("UserType") = reader.Item(13).ToString.ToUpper

                                    Response.Redirect("Admin_Menu.aspx", False)
                                ...
                                Else
                                    ...
                                    lblMessage.Text = "You are not administrator."
                ...
                Else
                    ...
                    lblMessage.Text = "Your User Name is Incorrect," & "<br />" & "Please Try Again."

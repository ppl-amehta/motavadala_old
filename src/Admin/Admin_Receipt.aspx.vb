...
Partial Class Admin_Receipt

    Inherits System.Web.UI.Page

    Dim TableName As String = Nothing

    Private Sub Admin_Receipt_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Session("SelectedYear") = "" Then
            ...
            lblUsername.Text = "User Name : " & Session("UserName")
        ...
        Else
            ...
            TableName = Session("SelectedYear")
            ...
            'Code For Disable Datepicker Future Dates After 31st March
            'txtDate.Attributes("max") = DateTime.Now.ToString("2022-12-22")

            Dim SessionYear As String = Nothing

            SessionYear = "20" & Microsoft.VisualBasic.Mid(TableName, 9, 2)
            ...
            If TableName = "[2022_2023]" Then
                'txtDate.Attributes("max") = DateTime.Now.ToString(DateTime.Now.Year & "-" & DateNow.Month & "-" & DateNow.Day)
                txtDate.Attributes("max") = DateTime.Now.ToString(SessionYear & "-" & "03" & "-" & "31")

            Else

                txtDate.Attributes("max") = DateTime.Now.ToString(CurrentYear & "-" & "03" & "-" & "31")
            ...
            Dim TempLastDate As Date = Nothing
                ...
                txtDate.Text = TempLastDate.ToString("yyyy-MM-dd")

            End If

        'lblMessage.Text = TableName.ToString
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            'if User ID or User Name Not Found, Redirect to Login Page, Display Please Login.
            If Session("UID") = "" Then
            ...
            Session("Page2Redirect") = "Admin_Receipt"
            ...
            If String.IsNullOrEmpty(Session("TempMobile")) = True Then
                ...
                meta.Content = "10;url=Admin_Receipt.aspx"

                Me.Page.Controls.Add(meta)
                lblMessage.Text = "Receipt is Generated, </br> You will now redirected in 10 seconds."
            ...
            Else
                ...
                'Response.Redirect("https://api.whatsapp.com/send?phone=" & RDonorMobile & "&text=Please%20Download%20Donation%20Receipt%20From%20Below%20Location.%20%20%20%20%20%20%20%20%20%20www.motavadalagauseva.org\Receipt_PDF\" & TempPDFName & ".pdf", FALSE)
                ...
                meta1.Content = "10;url=Admin_Whatsapp.aspx?91" & Session("TempMobile") & "," & Session("DonorName") & "," & Session("DonationAmount") & "," & Session("PDFfileName") & ".pdf"
